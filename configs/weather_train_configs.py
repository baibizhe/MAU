...
def configs():
    ...
    parser.add_argument('--real_length', type=int, default=40)
    parser.add_argument('--total_length', type=int, default=40)
    parser.add_argument('--img_height', type=int, default=480)
    parser.add_argument('--img_width', type=int, default=560)
    parser.add_argument('--sr_size', type=int, default=8) #修改了
    ...
    parser.add_argument('--num_hidden', type=int, default=64) #修改了
    ...
    parser.add_argument('--test_interval', type=int, default=300)
